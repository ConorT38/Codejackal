...
<div id = "alert_placeholder"></div>
    <div class="container">
      <div class="jumbotron">
        <h1>All of the users within the database</h1>      
         <br>
...
if ($result->num_rows > 0) {
     echo "<table><tr><th>Blog title</th><th>Content</th><th>Score</th></tr>";
     // output data of each row
     while($row = $result->fetch_assoc()) {
         echo "<tr><td>" . $row["TITLE"]. " " . $row["CONTENT"]. "</td><td>" . $row["VOTES"]. "</td><td></tr>";
     }
     echo "</table>";
} else {
     echo "0 results";
